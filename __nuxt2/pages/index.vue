<template>
  <div class="container mx-auto px-3 md:px-0">
    <section class="flex flex-col-reverse   md:flex-row justify-around items-center h-screen-without-header md:minus-4rem">
      ...
      <div>
        <img src="https://res.cloudinary.com/dmqgdno4p/image/upload/v1647646802/Blog/yo_jxeqii.webp" alt="foto perfil" title="yo" class="h-64 w-64 md:h-96 md:w-96 object-cover border-8 border-orange-400 rounded-3xl">
      </div>
    </section>
